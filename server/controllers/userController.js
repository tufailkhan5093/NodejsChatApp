...
{
    const messages = await Chat.findAll({where:[{SenderId:req.params.userId},{ReceiverId:req.params.receiverId}],include:[{model:User,as:"Sender"},{model:User,as:"Receiver"}]});
